var Module = (() => {
    ...
    return function(Module) {
        ...
        var _lnsocket_decrypt_header = (Module[
            ...
            return (_lnsocket_decrypt_header = Module[
                "_lnsocket_decrypt_header"
        ...
        var _lnsocket_make_ping_msg = (Module[
            ...
            return (_lnsocket_make_ping_msg = Module[
                "_lnsocket_make_ping_msg"
...
async function lnsocket_init() {
    ...
    const lnsocket_make_ping_msg = module.cwrap(
    ...
    LNSocket.prototype.connect = async function lnsocket_connect(
        node_id,
        host
    ) {
